...
ভাবুন, আপনার অ্যাপ একটি ডেস্কে কাজ করছে:
...
মেমরি লিক তখনই ঘটে যখন আপনি **পরিষ্কার করতে ভুলে যান**, বা **যে জিনিসগুলো আর ব্যবহার করেন না সেগুলোর রেফারেন্স রেখে দেন**।
...
container.removeChild(tempDiv); // পরিষ্কার মনে হচ্ছে
```
...
| ক্লিনআপ ছাড়া setInterval       | ক্লোজার এবং মেমরিকে जीवित রাখে  | কাজ শেষ হলে সবসময় `clearInterval()` কল করুন              |
